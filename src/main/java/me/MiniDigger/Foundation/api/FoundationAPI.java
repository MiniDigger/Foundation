...
public class FoundationAPI {
	...
	public static void registerLangKeys(LangKeyProvider key, Module m) {
	...
	public static void unregisterLangKeys(LangKeyProvider key, Module m) {
		Validate.notNull(key);
		Validate.notNull(m);
	...
	public static void registerEvents(Listener listener, Module m) {
	...
	public static void unregisterEvents(Listener listener, Module m) {
		Validate.notNull(listener);
		Validate.notNull(m);
	...
	public static void registerCommands(Object obj, Module m) {
		...
		} catch (CommandWrongParamsException e) {
			System.err.println("Go tell " + m.getDescription().author() + ", the author of the foundation module "
					+ m.getDescription().name() + " that he registered the commands in " + obj.getClass().getName()
					+ " wrong!");
			e.printStackTrace();
		}
	}

	public static void unregisterCommands(Object obj, Module m) {
		Validate.notNull(obj);
		Validate.notNull(m);
	...
	public static void onDisable(Module m) {
		Validate.notNull(m);
